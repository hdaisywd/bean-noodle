...
class CustomCell: UICollectionViewCell {
    ...
    class DetailScreen: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
        ...
        override func viewDidLoad() {
            ...
            nicknameLabel2.text = feed.title
            ...
            textView.text = "Description: " + feed.originalTitle
            //        "여행을 갔다왔다. 근데 여행을 또 가고 싶엇다. 헤헤. 음.. 나는 가고싶었던 곳이 과연어디인걸까? 생각을 한 번 해볼까? 아니.. 생각하기 싫다.. 응.. 생각하기 싫다.. 에휴... 벌써 새벽 3시다.. 세상에... 아 아닌가.. 일단은.. 뭐.. 좋네요.. 김광석 노래를 듣고 하모니카를 산 친구가 있댄다.. 아주 웃기다.. 그래서 꾸준히 연습은 했어? 내가 물었다. 아니? 친구가 대답했다. 사놓고 안했단다. "
